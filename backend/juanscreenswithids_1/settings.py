"""
Django settings for juanscreenswithids_1 project.
...
ROOT_URLCONF = 'juanscreenswithids_1.urls'
...
WSGI_APPLICATION = 'juanscreenswithids_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanscreenswithids_1 API",
    "DESCRIPTION": "API documentation for juanscreenswithids_1 App",
    "VERSION": "v1",
}
